...
class TestCreateIssue:
    ...
    @allure.step("Check the ability to create an issue with no summary")
    def test_create_issue_empty_summary(self):
        assert self.init_issue_page().create_issue("", "Blocker", "Victor Myasnikov", True) is False

    @allure.step("Check the ability to create an issue with long summary")
    ...
    @allure.step("Check the ability to create an issue with correct data")
